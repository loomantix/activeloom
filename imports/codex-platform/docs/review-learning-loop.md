# The review learning loop (Codex surface)
...
Read that first. This page carries only what is specific to the Codex surface.
...
- `.codex/references/roles/*.md` — the finder lenses.
- `.codex/skills/critique/SKILL.md` and `.codex/skills/deepcritique/SKILL.md`.
