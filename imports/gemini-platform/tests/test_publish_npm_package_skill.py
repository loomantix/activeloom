...
SCRIPTS = Path(__file__).resolve().parent.parent / ".agents/skills/publish-npm-package/scripts"
SKILL = Path(__file__).resolve().parent.parent / ".agents/skills/publish-npm-package/SKILL.md"
