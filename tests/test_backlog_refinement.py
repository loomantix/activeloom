...
CANDIDATES = REPO_ROOT / ".agents/skills/backlog-refinement/scripts/candidates.py"
BAIL_REPORT = REPO_ROOT / ".agents/skills/backlog-refinement/scripts/bail-report.py"
