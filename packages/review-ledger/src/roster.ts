...
/** Validate that reviewers are supported engines, distinct, and exclude the author. */
...
/** Collect actor-owned pass and completion attestations naming an exact head. */
...
/** Compute coverage and error if the review evidence is invalid or incomplete. */
