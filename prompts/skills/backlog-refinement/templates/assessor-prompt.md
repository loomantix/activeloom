...
- `<<SKILLS_ROOT>>/backlog-refinement/core-rubric.md` — the core rubric.
  ...
  "issues": [
    {
      ...
      "add_labels": ["<priority label>", "<agent-bail: … or dev: agent>", "<needs: … if any>"],
      "remove_labels": [],
