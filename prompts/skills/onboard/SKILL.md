---
name: onboard
description: Draft the project-specific values a fresh `.activeloom-config.yml` leaves blank — the stack table, code rules, and review focus — by reading the repository, then present them for confirmation.<<DESC_TRIGGER>>
<<FM_EXTRAS>>
---
