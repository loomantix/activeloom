---
name: product-grill
description: A relentless product interview that stress-tests a plan or design from the user's point of view until nothing about the user is silently assumed. Use when a product manager, designer, or other non-engineer wants a plan or design pressure-tested from the product and user side, before technical design.
---
