...
| `/grill <pr>`           | PR-first adversarial review. Lean default runs `code-reviewer` + `silent-failure-hunter`; `deep` runs the full matrix plus the conditional tenant-coupling pass.                                                                                                                                                                                                                                                                |
| `/deepgrill <pr>`       | PR-first local Claude chain (`/refactorpass` + `/grill deep`) with inline finding, fix-reply, and resolution traceability.                                                                                                                                                                                                                                                                                                      |
